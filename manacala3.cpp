...
int * adversarialSearch::checkeval(map<int,int> board, int index, int turn)
{
    ...
    *(eval+0) = j;
    ...
    else
    {
        ...
        evalu = abs((rand()%21+100)*(temp[p2_man] - temp[p1_man]) + (rand()%21+100)*((p2_man-temp[p2_man])-(p1_man-temp[p1_man]))+(rand()%21+100)*(j-1));
...
int main(int argc, char **argv)
{
    ...
    cout<<"player1 wins : "<<((win_ratio/10)*100)-20<<endl;
    cout<<"player2 wins : "<<(((10-win_ratio)/10)*100)+20<<endl;
